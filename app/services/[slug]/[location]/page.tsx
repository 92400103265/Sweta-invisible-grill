...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url:
        `https://www.invisiblesafetygrillpatna.com/services/${canonicalSlug}/${normalizedLocation}/`,
      ...
      images: [
        {
          ...
          height: 630,
          alt:
            `${service.title} - Professional Installation Services in ${locationFormatted}`,
        },
      ],
    ...
    '@graph': [
      {
        ...
        '@id':
          `${baseUrl}/services/${canonicalSlug}/${normalizedLocation}#service`,
        ...
        mainEntityOfPage: {
          ...
          '@id':
            `${baseUrl}/services/${canonicalSlug}/${normalizedLocation}`,
        },
        ...
        category:
          'Home Safety & Security Equipment',
        ...
        hasOfferCatalog: {
          ...
          name:
            `${service.title} Services in ${locationFormatted}`,
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                ...
                description:
                  `Professional ${service.title.toLowerCase()} consultation in ${locationFormatted}`,
              },
...

            {
              ...
              itemOffered: {
                ...
                name:
                  `Standard ${service.title} Installation`,
          ...
          <div className="container relative z-10">
            ...
            <div className="mx-auto max-w-4xl overflow-hidden rounded-2xl shadow-lg">
              ...
              <iframe
                ...
                title={
                  `Service area map for ${locationFormatted}`
                }
              />
