...
const LocationAboutSection = ({ location }: { location: string }) => {
  ...
  const handlePhoneChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // When phone just reached 10 digits and matches the expected pattern,
    // automatically move focus to the location field.
  ...
  const features = [
    `Professional installation team serving ${location}`,
  ...
  return (
    <>
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, #1E2A42 0%, #121D2F 100%)",
        }}
      >
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                >
                  ...
                  <span className="text-sm md:text-base font-semibold uppercase tracking-wide">
                    Sweta Invisible Grill in {location}
                  </span>
                </div>
                ...
                <p
                  ...
                  style={{ color: "#C8D8EE" }}
                >
                  Sweta Invisible Grill is your local expert in {location},
                  providing professional invisible grills, safety nets,
                  pigeon nets, bird protection and balcony safety solutions
                  for homes, apartments and commercial properties. We focus
                  on quality materials, professional installation and
            ...
            <div className="space-y-4 md:space-y-6">
                ...
                {stats.map((stat, index) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, #121D2F 0%, #1E2A42 100%)",
                        border:
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(75, 159, 255, 0.05) 0%, rgba(46, 127, 217, 0.05) 100%)",
                  border:
                    "1px solid rgba(75, 159, 255, 0.2)",
                }}
              >
